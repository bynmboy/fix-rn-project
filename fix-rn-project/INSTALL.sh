...
# fará a instalação do programa para facilitar seu uso, o mesmo precisará ser
# ser executado com permissẽs root e sudo.
#
# Versâo 1 : Criado recrusos fundamentaais de uso:
...
case $ARG_NAME in
	...
	-i | --install )
		...
		then
			...
			echo "Para confirmar digit ( Sim! ) no console:"
			echo
			echo -n "console ~$  "
			read OPC
			sleep 1
	...
	-e | --executable )
		sudo ln -s $DIR_SOFTWARE./fix-rn-project.sh $PATH_LINK
	;;
